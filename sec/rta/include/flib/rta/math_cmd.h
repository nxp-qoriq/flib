 ...
 */
static const unsigned math_op1_sz[] = {10, 10, 12, 12, 12, 12, 12};
 ...
 */
static const unsigned math_op2_sz[] = {8, 9, 13, 13, 13, 13, 13};
 ...
 * supported.
 */
static const unsigned math_result_sz[] = {9, 9, 10, 10, 10, 10, 10};
