 ...
 */
static const unsigned nfifo_src_sz[] = {4, 5, 5, 5, 5, 5};
 ...
 */
static const unsigned nfifo_flags_sz[] = {12, 14, 14, 14, 14, 14};
 ...
 * supported.
 */
static const unsigned nfifo_pad_flags_sz[] = {2, 2, 2, 2, 3, 3};
