					   ...
					   unsigned buffpos)
{
	...
	SHR_HDR(SHR_NEVER, 6, 0);
	{
		 ...
		 *                             nfu */
		/* [21] 00000042               imm1=66 */
		MATHB(MATH2, SUB, IMM(66), MATH2, 8, NFU | IFB);
		...
		MATHB(MATH0, ADD, IMM(0x78820000), MATH0, 4, NFU);
		...
		pmove1 = MOVE(MATH0, 0, DESCBUF, 0, IMM(4), WAITCOMP);
		 ...
		 *                              offset=-9 local->[35] */
		pjump3 = JUMP(IMM(lab35), LOCAL_JUMP, ANY_FALSE, MATH_Z);
