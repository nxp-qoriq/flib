...
unsigned test_move_op(uint32_t *buff)
{
	...
	MOVE(CONTEXT1, 22, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(CONTEXT1, 23, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(CONTEXT1, 25, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(CONTEXT1, 26, IFIFOAB2, 0, IMM(len), 0);
	MOVE(CONTEXT1, 27, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(CONTEXT2, 6, CONTEXT1, 0, IMM(len), WAITCOMP);
	MOVE(CONTEXT2, 7, CONTEXT2, 0, IMM(len), 0);
	MOVE(CONTEXT2, 9, CONTEXT2, 0, IMM(len), WAITCOMP);
	...
	MOVE(CONTEXT2, 2, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(CONTEXT2, 3, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(CONTEXT2, 5, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(CONTEXT2, 6, IFIFOAB2, 0, IMM(len), 0);
	MOVE(CONTEXT2, 7, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(OFIFO, 0, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(OFIFO, 0, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(OFIFO, 0, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(OFIFO, 0, IFIFOAB2, 0, IMM(len), 0);
	MOVE(OFIFO, 0, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(DESCBUF, 14, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(DESCBUF, 15, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(DESCBUF, 17, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(DESCBUF, 18, IFIFOAB2, 0, IMM(len), 0);
	MOVE(DESCBUF, 19, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(MATH0, 14, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(MATH0, 15, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(MATH0, 17, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(MATH0, 18, IFIFOAB2, 0, IMM(len), 0);
	MOVE(MATH0, 19, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(MATH1, 14, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(MATH1, 15, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(MATH1, 17, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(MATH1, 18, IFIFOAB2, 0, IMM(len), 0);
	MOVE(MATH1, 19, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(MATH2, 14, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(MATH2, 15, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(MATH2, 17, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(MATH2, 18, IFIFOAB2, 0, IMM(len), 0);
	MOVE(MATH2, 19, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(MATH3, 14, IFIFOAB1, 0, IMM(len), FLUSH1);
	MOVE(MATH3, 15, IFIFOAB1, 0, IMM(len), LAST1);
	MOVE(MATH3, 17, IFIFOAB1, 0, IMM(len), LAST1 | FLUSH1);
	MOVE(MATH3, 18, IFIFOAB2, 0, IMM(len), 0);
	MOVE(MATH3, 19, IFIFOAB2, 0, IMM(len), LAST2);
	...
	MOVE(IFIFOAB1, 0, OFIFO, 0, IMM(5128), FLUSH1);
	...
	MOVE(IFIFOAB2, 0, OFIFO, 0, IMM(5128), FLUSH2);
