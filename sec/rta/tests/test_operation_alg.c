...
/* MDHA family tests */
		...
		ALG_OPERATION(OP_ALG_ALGSEL_MD5, OP_ALG_AAI_SMAC,
			      OP_ALG_AS_INITFINAL, ICV_CHECK_ON, 0);
		...
		ALG_OPERATION(OP_ALG_ALGSEL_SHA224, OP_ALG_AAI_HMAC,
			      OP_ALG_AS_FINALIZE, ICV_CHECK_ON, 0);
